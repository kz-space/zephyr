 ...
 * mm_vm_page_frames with K_PAGE_FRAME_RESERVED. This function is called at
 ...
 * MM_VM_SCRATCH_PAGE, with read/write access to supervisor mode, such that
 * when this function returns, the calling context can read/write the page
 * frame's contents from the MM_VM_SCRATCH_PAGE address.
 *
