...
static int lsm9ds1_mag_attr_set(const struct device *dev,
...
static inline void lsm9ds1_mag_convert(struct sensor_value *val, int raw_val,
...
static int lsm9ds1_mag_channel_get(const struct device *dev,
...
#define LSM9DS1_MAG_CONFIG_COMMON(inst)						\
	.mag_odr =	DT_INST_PROP(inst, mag_odr),				\
	.mag_range =	DT_INST_PROP(inst, mag_range),				\
...
#define LSM9DS1_MAG_DEFINE(inst)							\
	static struct lsm9ds1_mag_data lsm9ds1_mag_data_##inst =			\
			{.mag_gain = 0, .powered_down = 0};				\
											\
	static struct lsm9ds1_mag_config lsm9ds1_mag_config_##inst =			\
			LSM9DS1_MAG_CONFIG_I2C(inst);					\
											\
											\
	SENSOR_DEVICE_DT_INST_DEFINE(inst, lsm9ds1_mag_init, NULL,			\
				&lsm9ds1_mag_data_##inst, &lsm9ds1_mag_config_##inst,	\
				POST_KERNEL, CONFIG_SENSOR_INIT_PRIORITY,		\
				&lsm9ds1_mag_api_funcs);				\
