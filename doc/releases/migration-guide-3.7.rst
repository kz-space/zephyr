 ...
 * A completely new HCI driver API was introduced and the old one deprecated. The new API
   follows the "usual" driver API design in Zephyr, with devicetree nodes, etc. The host now
