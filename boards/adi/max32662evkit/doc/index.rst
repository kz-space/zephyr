...
.. image:: img/max32662evkit_img1.jpg
   :align: center
   :alt: MAX32662EVKIT Front

.. image:: img/max32662evkit_img2.jpg
   :align: center
   :alt: MAX32662EVKIT Back
...
An Arm® debug access port (DAP) provides an external interface
for debugging during application development.
The DAP is a standard Arm CoreSight® serial wire debug port,
uses a two-pin serial interface (SWDCLK and SWDIO), and is accessed
through 10-pin header (J3). Logic levels are set to V_AUX (1V8 or 3V3),
which is determined by the shunt placement on JP11. In addition,
