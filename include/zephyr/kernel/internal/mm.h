 ...
 *
 *     virt_addr = phys_addr + MM_MEMMAP_VIRT_OFFSET
 *
 ...
 */
#ifdef CONFIG_MMU
#define MM_MEMMAP_VIRT_OFFSET	((CONFIG_KERNEL_VM_BASE + CONFIG_KERNEL_VM_OFFSET) - \
 ...
 */
void mm_memmap_phys_bare_map(uint8_t **virt_ptr, uintptr_t phys, size_t size,
			     uint32_t flags);
 ...
 * unmapped using mm_memmap_phys_guard_unmap().
 *
...
/**
 * Un-map memory mapped via mm_memmap_phys_guard_map().
 *
